        ...
        <div className="container mx-auto px-6">
            ...
            <div className="flex flex-col lg:flex-row justify-between items-center gap-8 lg:gap-16 my-6 lg:my-12">
                ...
                <div className="w-full lg:w-1/2">
                    <form onSubmit={handleRegister} className="w-full border-2 rounded-lg p-8 lg:p-16">
                        <h3 className="text-3xl lg:text-4xl font-semibold text-center mb-6 lg:mb-12 opacity-80">Register</h3>
                        ...
                        <p className="text-lg text-center"><span className="opacity-80">Already have an account? </span><Link to="/login" className=" font-semibold text-[#FF3811]">Login</Link></p>
                    </form>
                </div>
            </div>
        </div>
